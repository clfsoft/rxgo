...
// ToObservablesConfig is the configuration type for ToObservables.
type ToObservablesConfig struct {
	Flat func(observables ...Observable) Observable
}

// MakeFunc creates an OperatorFunc from this type.
func (conf ToObservablesConfig) MakeFunc() OperatorFunc {
	return MakeFunc(toObservablesOperator(conf).Call)
}

type toObservablesOperator ToObservablesConfig
