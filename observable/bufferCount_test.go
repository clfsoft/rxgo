...
func TestOperators_BufferCount(t *testing.T) {
	subscribe(
		...
		[]Observable{
			...
			Just("A", "B", "C", "D", "E", "F", "G").Pipe(BufferCountConfig{3, 1}.MakeFunc(), toString),
			Just("A", "B", "C", "D", "E", "F", "G").Pipe(BufferCountConfig{3, 2}.MakeFunc(), toString),
			Just("A", "B", "C", "D", "E", "F", "G").Pipe(BufferCountConfig{3, 4}.MakeFunc(), toString),
		},
